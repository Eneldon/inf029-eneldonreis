        ...
        if(opMenu1 == 1)
            {                 
                  do{
                        ...
                        printf("\n5 - Listar Alunos ordem alfabetica:");
                        printf("\n6 - Listar Aniversariante do mes:");
                        printf("\nOpcao:");
                        scanf("%d",&opcao);
                        getchar();
                        ...
                        switch (opcao) 
                             {
                                 ...
                                 /*   case 2:{
                                    ...
                                    break;
                                     ...
                                     case 4:{
                                          listarAlunoSexo(lista_aluno, qtd_alunos_cadastrado, qtd_alunos);
                                    break;
                                     }
                                     case 5:{
                                          ListarAlunosOrdemAlfabetica(lista_aluno, qtd_alunos_cadastrado, qtd_alunos);
                                    break;
                                     }
                                     case 6:{
                                          ListarAniversariantesdoMesAluno(lista_aluno, qtd_alunos_cadastrado, qtd_alunos);
                                    break;
                                     }
                                    default:{
                  ...
                  do{
                        ...
                        printf("\n5 - Listar  professores ordem alfabetica:");
                        printf("\n6 - Listar Aniversariante do mes:");
                        printf("\n0 - sair:");
                        printf("\nOpcao:");
                        scanf("%d",&opcao);
                        ...
                        switch (opcao)
                        {
                         ...
                         /*     case 2:{
                              ...
                              case 4:{
                                    listarProfessorSexo(lista_professor,qtd_professor_cadastrado, qtd_professor);
                              break;
                              }
                              case 5:{
                                    ListarProfessoresOrdemAlfabetica(lista_professor,qtd_professor_cadastrado,qtd_professor);
                                    break;
                                     }
                              case 6:{
                                    ListarAniversariantesdoMesProfessor(lista_professor,qtd_professor_cadastrado, qtd_professor);
                                    break;
                                     }
                              default:{
                                    printf("Opcao Invalida\n");
